...
public class DriftCorrection_Old {

    public static final double UMPERMIN = 150;
    ...
    static double[] driftCorrection(Mat img1, Mat img2){
        //        new ImageJ();
...
//        Imgcodecs.imwrite("/home/nolwenngueguen/Téléchargements/ImagesTest/ImagesPNG/goodMatches.tif", imgGoodMatches);
    ...
    static void parallelization(Mat img1, Mat img2) throws ExecutionException, InterruptedException {
        ExecutorService es = Executors.newSingleThreadExecutor();
        Future job = es.submit(new ThreadAttribution(img1, img2));
    ...
    public static void main (String[] args) {
        ...
        Mat img1 = readImage("/home/dataNolwenn/Résultats/06-03-2018/ImagesFocus/19-1.tif");
        Mat img2 = readImage("/home/dataNolwenn/Résultats/06-03-2018/ImagesFocus/19-115.tif");
        try {
            parallelization(img1, img2);
    ...
    private static class ThreadAttribution implements Callable<double[]> {
        ...
        @Override
        public double[] call() {
            return driftCorrection(img1_, img2_);
        }
    }
}
